  ...
  getTicketsById(){
    ...
    try {
      ...
      // }, {});
        ...
        this.usedTicket = this.allRecords.reduce((acc, {used})=>acc + (used === "0" ? 0 : 1), 0);
        console.log(this.usedTicket);
        this.bestCustomers = this.statService.getTicketSoldByAmount(this.allRecords, this.ticketSum);
        this.bestCategories = this.statService.getTicketSoldByCategory(this.allRecords); 
        this.bestChannels =  this.statService.getTicketSoldByChannel(this.allRecords, this.ticketSum);
